...
public class Quadtree {
	...
	private int getIndex(Entity ent) {
		...
		AABB entBoundingBox = AABB.enclosingBox(new AABB(ent.getEndPosition(), ent.getSize()), ent.getEndBoundingBox());
	...
	public ArrayList<Entity> retrieve(ArrayList<Entity> collidableEntities, Entity ent) {
